...
public class StartProgram {
		...
		static TeamHelper sth = new TeamHelper();

		private static void addTeam() {
			/*
			 * System.out.print("Enter a city: "); String city = in.nextLine();
			 * System.out.print("Enter a name: "); String name = in.nextLine();
			 * System.out.print("Enter a sport: "); String sport = in.nextLine(); SportsTeam
			 * toAdd = new SportsTeam(city, name, sport); sth.insertTeam(toAdd);
			 * System.out.println("Added " + toAdd);
			 */		}

		private static void deleteTeam() {
			/*
			 * System.out.print("Enter the city to delete: "); String city = in.nextLine();
			 * System.out.print("Enter the name to delete: "); String name = in.nextLine();
			 * SportsTeam toDelete = new SportsTeam(city, name, ""); toDelete =
			 * sth.deleteTeam(toDelete); System.out.println("Deleted " + toDelete);
			 */		}
		...
		private static void editTeam() {
			...
			if (!foundnames.isEmpty()) {
				...
				for (Team l : foundnames) {
					System.out.println(l.getId() + " : " + l.toString());
				}
				System.out.print("Which ID to edit: ");
				int idToEdit = in.nextInt();

				Team toEdit = sth.searchForTeamById(idToEdit);
...
//					toEdit.setSport(newSport);					
		...
		private static void viewTheList() {
			List<Team> allTeams = sth.showAllTeams();
